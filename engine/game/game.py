...
class Game:
    ...
    def __init__(self, main_dir, error_log, dev_mission=None):
        ...
        # battle object group
        self.battle_cameras = {"ui": sprite.LayeredUpdates()}
        ...
        self.stage_objects = sprite.Group()  # group to keep all scene objects for event delete check
        ...
        self.loading_lore_text_popup = TextPopup(font_size=int(128 * self.screen_scale[1]))
