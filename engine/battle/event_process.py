    ...
    for event_index, child_event in enumerate(self.cutscene_playing.copy()):
        ...
        if "story choice" not in event_property or event_property["story choice"] == mission_choice_appear + "_" + \
            ...
            if child_event["Object"] == "camera":
                ...
                scene = self.scenes[child_event["Type"]]

                scene.fade_start = True
                scene.fade_in = False
                scene.fade_out = False
                ...
                scene.fade_delay = 0
                if "speed" in event_property:
                    scene.fade_speed = event_property["speed"]
                if "timer" in event_property:
                    scene.fade_delay = event_property["timer"]
                self.cutscene_playing.remove(child_event)
                ...
                if child_event["Type"] == "create":  # add character for cutscene
                    ...
                    AICharacter(self.battle_cameras[event_property["Camera"]],
                                game_id, layer_id,
                    ...
                    if "flip" in event_property:
                        flip = 1
                    StageObject(self.battle_cameras[event_property["Camera"]],
                                child_event["Object"], event_property["POS"], child_event["Object"],
